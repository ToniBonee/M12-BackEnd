...
if ($inc) {
	...
	$query = "SELECT * FROM productos  left join categorias  on  categorias.id_categoria = productos.id_categoria WHERE productos.id_categoria = 1 and productos.stock > 0  LIMIT 3";
